...
| [`user-data-isolation.md`](./user-data-isolation.md) | 🟡 Ready to hand off | Per-user `user_id` on all tables, new RLS, local cache wipe on user switch. Wipes existing shared data. |
